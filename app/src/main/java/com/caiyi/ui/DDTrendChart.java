...
public class DDTrendChart extends ATrendChart {
    ...
    public void updateData(String str, ArrayList<TrendData> arrayList) {
        if (arrayList != null && arrayList.size() != 0) {
            ...
            this.mScaleRange = new float[]{0.0f, 0.5f};
            //双色球
            if ("01".equals(this.mLotteryType)) {
                this.redCount = mDefSSQRedCount;
                this.blueCount = mDefSSQBlueCount;
                for (int i = 0; i < arrayList.size(); i++) {
                    TrendData trendData = (TrendData) arrayList.get(i);
                    if ("row".equals(trendData.getType())) {
                        String[] blueBalls = trendData.getBlue().split(",");
                        for (int i2 = 0; i2 < blueBalls.length; i2++) {
                            if (blueBalls[i2].equals("0")) {
                                float f = (((((float) this.redCount) + 0.5f) + ((float) i2)) * ((float) this.mXItemWidth)) + ((float) this.mDivWidth) + this.mXItemWidth * 5;
                ...
                this.redCount = mDefDLTRedCount;
                this.blueCount = mDefDLTBlueCount;
            }
    ...
    public void drawXTop() {
        int i;
        int i2 = this.mDivWidth + (this.mXItemWidth * (this.redCount + this.blueCount + 5));
        int i3 = this.mXItemHeight + 60;
        ...
        int awardResultsWidth = this.mXItemWidth * 5;
        this.mPaint.setColor(-1);
        beginRecording.drawLine((float) awardResultsWidth, 0, (float) awardResultsWidth, (float) i3, this.mPaint);
        beginRecording.drawLine(0, (float) i3, (float) awardResultsWidth, (float) i3, this.mPaint);
        this.mRect.set(0, 0, awardResultsWidth, i3);
        drawText2RectCenter("开奖结果", beginRecording, this.mRect, this.mPaint);

        int totoalRedAndBlueWidth = (this.redCount + this.blueCount) * this.mXItemWidth;
        this.mPaint.setColor(-1);
        beginRecording.drawLine(awardResultsWidth, (float) i3 / 3, (float) totoalRedAndBlueWidth + awardResultsWidth, (float) i3 / 3, this.mPaint);
        this.mRect.set(awardResultsWidth, 0, totoalRedAndBlueWidth + awardResultsWidth, i3 / 3);
        drawText2RectCenter("基本", beginRecording, this.mRect, this.mPaint);

        int totoalRedWidth = this.redCount * this.mXItemWidth;
        this.mPaint.setColor(-1);
        beginRecording.drawLine(awardResultsWidth, (float) i3 * 2 / 3, (float) totoalRedWidth + awardResultsWidth, (float) i3 * 2 / 3, this.mPaint);
        this.mRect.set(awardResultsWidth, i3 / 3, totoalRedWidth + awardResultsWidth, i3 * 2 / 3);
        drawText2RectCenter("红球", beginRecording, this.mRect, this.mPaint);

        int totoalBlueWidth = this.blueCount * this.mXItemWidth;
        this.mPaint.setColor(-1);
        beginRecording.drawLine((float) totoalRedWidth + awardResultsWidth, (float) i3 * 2 / 3, (float) totoalRedWidth + this.mXItemWidth + totoalBlueWidth + awardResultsWidth, (float) i3 * 2 / 3, this.mPaint);
        beginRecording.drawLine((float) totoalRedWidth + awardResultsWidth, (float) i3 * 1 / 3, (float) totoalRedWidth + awardResultsWidth, (float) i3, this.mPaint);
        this.mRect.set(totoalRedWidth + awardResultsWidth, i3 / 3, totoalRedWidth + this.mXItemWidth + totoalBlueWidth + awardResultsWidth, i3 * 2 / 3);
        drawText2RectCenter("蓝球", beginRecording, this.mRect, this.mPaint);

        for (i = 1; i <= this.redCount; i++) {
            String str;
            int i4 = i * this.mXItemWidth + awardResultsWidth;
            this.mPaint.setColor(this.mCDiv);
            beginRecording.drawLine((float) i4, (float) i3 * 2 / 3, (float) i4, (float) i3, this.mPaint);
            this.mRect.set(i4 - this.mXItemWidth, i3 * 2 / 3, i4, i3);
            this.mPaint.setColor(-1);
            if (i <= 9) {
                str = "0" + i;
            } else {
        ...
        for (i = 0; i < this.blueCount; i++) {
            String str;
            int i4 = ((this.redCount + i) * this.mXItemWidth) + this.mDivWidth + awardResultsWidth;
            beginRecording.drawLine((float) i4, (float) i3 * 2 / 3, (float) i4, (float) i3, this.mPaint);
            this.mRect.set(i4, i3 * 2 / 3, this.mXItemWidth + i4, i3);
            this.mPaint.setColor(-1);
            if (i < 9) {
                str = "0" + (i + 1);
            } else {
    ...
    public void drawXBottom() {
        int i = 1;
        int i2 = (this.mXItemWidth * (this.redCount)) + this.mDivWidth + this.mXItemWidth * 5;
        int i3 = this.mXItemHeight + this.mBottomMargin;
        Canvas beginRecording = this.mPicXBottom.beginRecording(i2, i3);
        this.mRect.set(this.mXItemWidth * 5, 0, i2 + this.mXItemWidth * 5, i3);
        this.mPaint.setStyle(Style.FILL);
        this.mPaint.setColor(-1);
        beginRecording.drawRect(this.mRect, this.mPaint);
        this.mPaint.setColor(this.mCDiv);
        beginRecording.drawLine(this.mXItemWidth * 5, 2.0f, (float) i2 + this.mXItemWidth * 5, 2.0f, this.mPaint);
        this.mPaint.setTextSize((float) this.mXTextSize);
        for (int i4 = 1; i4 <= this.redCount; i4++) {
            String str;
            this.mRect.set((i4 - 1) * this.mXItemWidth + 5 * this.mXItemWidth, this.mBottomMargin, this.mXItemWidth * i4 + this.mXItemWidth * 5, i3);
        ...
        while (i <= this.blueCount) {
            String str2;
            this.mRect.set((((this.redCount + i) - 1) * this.mXItemWidth) + this.mDivWidth + this.mXItemWidth * 5, this.mBottomMargin, ((this.redCount + i) * this.mXItemWidth) + this.mDivWidth + this.mXItemWidth * 5, i3);
    ...
    public void drawContent() {
        ...
        this.mPaint.setStyle(Style.FILL);
        int ballCount = this.redCount + this.blueCount;
        int size = this.mTrendData.size();
        for (i = 0; i <= size; i++) {
            ...
            if (i != size) {
                if (i < size - 4) {
                    ...
                    this.mRect.set(this.mXItemWidth * 5, i4, i2 + this.mXItemWidth * 16, this.mXItemHeight + i4);
                    beginRecording.drawRect(this.mRect, this.mPaint);
                    this.mPaint.setColor(this.mCDiv);
                    beginRecording.drawLine(0.0f, (float) i4, (float) i2, (float) i4, this.mPaint);
                } else {
                    this.mRect.set(this.mXItemWidth * 5, this.mDivHeight + i4, i2 + this.mXItemWidth * 16, (i4 + this.mDivHeight) + this.mXItemHeight);
                    if (i == (size - 4) + 1) {
                        this.mPaint.setColor(this.mCAvgYilouBg);
                    } else if (i == size - 1) {
                        this.mPaint.setColor(this.mCLianchuBg);
        ...
        for (i = 0; i <= ballCount; i++) {
            int i5 = i * this.mXItemWidth + this.mXItemWidth * 5;
            if (i == this.redCount) {
                this.mPaint.setColor(-1);
        ...
        beginRecording.drawRect(this.mRect, this.mPaint);
        this.mPaint.setColor(this.mCDiv);
        beginRecording.drawLine(this.mXItemWidth * 5, (float) i, (float) i2 + this.mXItemWidth * 5, (float) i, this.mPaint);
        beginRecording.drawLine(this.mXItemWidth * 5, (float) ((this.mDivHeight + i) - 1), (float) i2 + this.mXItemWidth * 5, (float) ((this.mDivHeight + i) - 1), this.mPaint);
        ...
        for (int i6 = 0; i6 < i; i6++) {
            ...
            String[] redBalls = trendData.getRed().split(",");
            String[] blueBalls = trendData.getBlue().split(",");
            int i8 = this.mXItemHeight * i6;
            if (i6 >= i - 4) {
                i8 += this.mDivHeight;
            }
            for (ballIndex = 0; ballIndex < redBalls.length; ballIndex++) {
                this.mRect.set(this.mXItemWidth * ballIndex + this.mXItemWidth * 5, i8, (ballIndex + 1) * this.mXItemWidth + this.mXItemWidth * 5, this.mXItemHeight + i8);
                if (!"row".equals(trendData.getType())) {
                    this.mPaint.setColor(ViewCompat.MEASURED_STATE_MASK);
                    drawText2Rect(redBalls[ballIndex], beginRecording, this.mRect, this.mPaint);
                } else if (redBalls[ballIndex].equals("0")) {
            ...
            for (ballIndex = 0; ballIndex < blueBalls.length; ballIndex++) {
                this.mRect.set(((redBalls.length + ballIndex) * this.mXItemWidth) + this.mDivWidth + this.mXItemWidth * 5, i8, (((redBalls.length + ballIndex) + 1) * this.mXItemWidth) + this.mDivWidth + this.mXItemWidth * 5, this.mXItemHeight + i8);
                if (!"row".equals(trendData.getType())) {
                    this.mPaint.setColor(ViewCompat.MEASURED_STATE_MASK);
                    drawText2Rect(blueBalls[ballIndex], beginRecording, this.mRect, this.mPaint);
                } else if (blueBalls[ballIndex].equals("0")) {
                    this.mPaint.setColor(this.mCBallBlue);
                    beginRecording.drawCircle(this.mRect.exactCenterX(), (float) this.mRect.centerY(), (float) this.mDefBallSize, this.mPaint);
                    this.mPaint.setColor(-1);
                    if (ballIndex < 9) {
